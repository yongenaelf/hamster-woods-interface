  ...
  return (
    <div className="mb-2 flex w-full flex-grow flex-col rounded-2xl bg-blue-400 p-2 shadow-inner">
      <div className="mb-[1px] flex w-full flex-row items-center justify-between rounded-tl-2xl rounded-tr-2xl bg-blue-700 p-4 shadow-inner">
        <select
          className={`bg-blue-700 font-roboto text-white ${
            isMobile ? "p-2.5 text-lg" : "p-2 text-3xl"
          }`}
        ...
        <div
          className={`font-normal leading-none text-white text-opacity-60 ${
      ...
      >
        <div className="flex py-8">
          <div className="flex-1">
            <div className="mb-2 font-normal leading-none text-white text-opacity-60">
              Points
            </div>
            <div
          ...
          <tbody>
            {his?.weeks.map((i, idx) => (
              <tr key={idx} className="border-b border-white border-opacity-40">
                ...
                <td className="py-4">
                  {i.score || (
                    <div className="text-white text-opacity-60">Not in</div>
                  )}
                </td>
